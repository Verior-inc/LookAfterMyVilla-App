...
const Input = ({icon,placeholder,value,onChangeText,borderColor,width,borderRadius,descBox,bgColor}) => {
    ...
    return (
        <View style={{
            ...
            style={{paddingLeft:10,color:'black',flex:1,alignSelf:'flex-start'}}
            />
        </View>
    );
};
