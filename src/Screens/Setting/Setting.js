  ...
  return (
    <ScrollView contentContainerStyle={{flexGrow: 1, backgroundColor: 'white'}}>
      <TouchableOpacity
        ...
        style={{alignSelf: 'flex-start', top: 10, left: 10}}>
        <Icon
          type="MaterialIcons"
          name="arrow-back"
          size={30}
      ...
      <View style={styles.userprofile}>
        <View>
          <Text
            style={{fontFamily: SemiBold, fontSize: 19, textAlign: 'center'}}>
            {userData?.name}
          </Text>
          <Text
            style={{
        ...
        <View style={styles.btncon}>
          <TouchableOpacity style={styles.changePasswordbtn}>
            <View
              ...
              <Icon
                ...
                color={'grey'}
              />
              <Text style={styles.changePasswordbtntxt}>Language</Text>
            </View>
            <Icon
              type="font-awesome-5"
              name="chevron-right"
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              props.navigation.navigate('ChangePassword', {
                ...
                placeholderprivious: 'Enter your Previous passowd',
                resetpassword: false,
              })
            }>
            <View
          ...
          <TouchableOpacity
            ...
            <View
              ...
              <Text style={styles.changePasswordbtntxt}>Report Bugg</Text>
            </View>
            <Icon
              type="font-awesome-5"
              name="chevron-right"
          ...
          <TouchableOpacity
            ...
            <View
              ...
              />
              <Text
                style={styles.changePasswordbtntxt}
                style={styles.changePasswordbtntxt}>
                Addresses
              </Text>
            </View>
